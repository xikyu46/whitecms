...
--
-- Host: localhost
-- Generation Time: Jan 17, 2016 at 09:13 AM
...
(9, 'Tampilan', 'Template', 4, NULL, 0, 2, NULL),
(10, 'Single Video', 'Single Video', 4, NULL, 0, 3, NULL),
(11, 'List Post', 'List Post', 4, NULL, 0, 4, NULL),
(12, 'Dropdown', 'Dropdown', 4, NULL, 0, 5, NULL),
...
(22, 'title 1', 'title englsih', 4, NULL, 0, 1, NULL),
(23, 'Buntut', 'Tail', 4, NULL, 0, 6, NULL);
...
(1, 1420070400, 'Lorem', ' Lorem english ', 'Polsek Jebres Bersama Pengelola Stasiun Jebres Lakukan Cek Rel', 'Polsek Jebres english content', 'http://www.surakarta.go.id/konten/sejarah-kota', 'http://surakarta.tratapp.com/assets/slidebanner1-1450032395.png', 1),
(2, 1420070400, 'Ipsum', '', 'dolor lorem ipsum matet sitet', '', 'http://surakarta.tratapp.com/assets/slidebanner2-1450032406.png', 'http://surakarta.tratapp.com/assets/slidebanner2-1450032406.png', 1),
(3, 0, '', '', 'lorem ipsum dolor sitet matet', '', 'http://surakarta.tratapp.com/assets/slidebanner3-1450032411.png', '', 1),
(4, 0, '', '', 'Maulid Nabi Bersama Habib Syeh', '', 'http://surakarta.tratapp.com/assets/01-1451229693.jpg', '', 0),
(5, 0, '', '', 'Kado Spesial', '', 'http://surakarta.tratapp.com/assets/wtn-1451146605.jpg', '', 1);
...
(6, 'custom', '<a class="twitter-timeline"  href="https://twitter.com/hashtag/kotasolo" data-widget-id="684208181883453440">#kotasolo Tweets</a>\n							<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?''http'':''https'';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>', 'fa-youtube', 1);
...
(27, '', NULL, 'admin', 1452816000, 1452850166, 'judul', 'judul english', '<p>Waktu&nbsp; : 30 - 31 Januari 2016</p>\n\n<p>Lokasi&nbsp; : Pasar Kliwon (alun-alun selatan)</p>\n\n<p>Peringatan Haul habib Ali Bin Muhammad al Habsyi yang rutin digelar setiap tahun, bertempat di Pasar Kliwon.</p>\n', '<p>lorem&nbsp;</p>\n', NULL, NULL, 'event', '', '', '', '', 'http://surakarta.tratapp.com/assets/mobilpelayanankependudukan1-1452525595.jpg', NULL, 'post', '', 0, 1),
(28, 'tahun-baru-2016', NULL, 'admin', 1451606400, 1452850395, 'Tahun Baruan Di Solo', 'new year', '<p>test</p>\n', '<p>test</p>\n', NULL, NULL, 'event', '', '', '', '', 'http://surakarta.tratapp.com/assets/mobilpelayanankependudukan1-1452525595.jpg', NULL, 'post', '', 0, 1);
