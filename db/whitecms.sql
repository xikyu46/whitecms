...
--
-- Host: localhost
-- Generation Time: Dec 12, 2015 at 10:32 AM
...
INSERT INTO `page` (`id`, `url`, `catid`, `author`, `date`, `title`, `title_en`, `content`, `content_en`, `excerpt`, `excerpt_en`, `type`, `meta_key`, `meta_key_en`, `meta_desc`, `meta_desc_en`, `template`) VALUES
(4, 'semarang', 0, '0', 1449860030, 'Home', 'home', 'home', 'home', '', '', 'page', 'home', 'home', 'home', 'home', 'home'),
(5, 'simple.html', 0, '0', 1449845093, 'Simple Post', '', 'simple', '', 'simple', '', 'page', '', '', '', '', 'home');
