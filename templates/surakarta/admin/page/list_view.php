	...
	<div class="row">
		<div class="col-sm-3">
			<div id="jstree-proton-1" style="margin-top:20px;" class="proton-demo">
				...
				<? }?>
				<a href="<?= base_url('admin/page/add');?>">Add Page</a>
			</div>	
		</div>
					...
					<div class="panel-body">
						...
						<hr/>
							...
							<div class="control-group">
								<label>Url</label>
								<div class="controls">
									<input type="text"  name="url" value="<?= $page->url;?>" class="form-control" placeholder="Title">
								</div>
							</div>
							<div class="control-group">
								<label>content</label>
							...
							<div class="control-group">
								<label>content</label>
								<div class="controls">
									<textarea name="content_en"  id="editor-en" class="form-control"><?= $page->content_en;?></textarea>	
								</div>
							</div>
							<div class="control-group">
								<label>Meta Key</label>
