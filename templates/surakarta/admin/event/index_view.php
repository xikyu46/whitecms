			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Event Panel</h3>
					...
					<div class="panel-body">
						<div class="row"> <!-- start: sort, search and new -->
							...
							<div class="col-md-4">
								<a class="btn btn-success pull-right" href="<?= base_url('admin/event/add');?>" role="button"><i class="fa fa-plus"></i> Add Event</a>
							</div>
						</div>
						<hr />
						<div class="table-responsive">
							<table class="table table-bordered table-hover table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td>
										<a href="<?= base_url('admin/event/edit/'.$blogRow->id);?>">Edit</a> | 
							...
							<nav> <!-- start: pagination -->
								<ul class="pagination">
									<?= showpage(current_url(),$count_event);?>
								</ul>
							</nav>
						</div>
					</div> <!-- end: panel body -->
...
function deletePage(id){
	bootbox.confirm('Anda yakin akan menghapus halaman ini? ',function(result){
		if (result === null) {                                             
			...
			if(result == true){
				$.get(base_url+'admin/event/delete/'+id,function(data){
